...
<div class="flex h-full">
    <aside class="w-64 bg-blue-950 shadow-md px-4 py-6 flex flex-col">
        ...
        <nav class="flex-1 space-y-4 text-gray-300">
            <a href="#" class="block py-2 px-4 rounded hover:text-white hover:bg-blue-900">Dashboard</a>
            <a href="#" class="block py-2 px-4 rounded hover:text-white hover:bg-blue-900">Meus Cursos</a>
            <a href="#" class="block py-2 px-4 rounded hover:text-white hover:bg-blue-900">Todos os Cursos</a>
            ...
            <a href="{{ route('logout') }}" class="block py-2 px-4 rounded hover:bg-red-500 text-red-500 hover:text-white">Terminar Sessão</a>
        </nav>
    </aside>
